...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "b4a.dictionaries", "b4a.dictionaries.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.dictionaries", "b4a.dictionaries.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.dictionaries.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
vis = vis | (layout2.mostCurrent != null);
vis = vis | (login.mostCurrent != null);
vis = vis | (manage.mostCurrent != null);
vis = vis | (add.mostCurrent != null);
vis = vis | (edit.mostCurrent != null);
return vis;}
...
public static void killProgram() {
 ...
 {
            Activity __a = null;
            if (layout2.previousOne != null) {
				__a = layout2.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(layout2.mostCurrent == null ? null : layout2.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
...
BA.applicationContext.stopService(new android.content.Intent(BA.applicationContext, imagedownloader.class));
 ...
 {
            Activity __a = null;
            if (manage.previousOne != null) {
				__a = manage.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(manage.mostCurrent == null ? null : manage.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
 ...
 {
            Activity __a = null;
            if (edit.previousOne != null) {
				__a = edit.previousOne.get();
			}
            else {
                BA ba = killProgramHelper(edit.mostCurrent == null ? null : edit.mostCurrent.processBA);
                if (ba != null) __a = ba.activity;
            }
            if (__a != null)
				__a.finish();}
...
public anywheresoftware.b4a.objects.ButtonWrapper _mainbtn = null;
...
RDebugUtils.currentLine=131073;
 //BA.debugLineNum = 131073;BA.debugLine="Activity.LoadLayout(\"MainPage\")";
...
RDebugUtils.currentLine=327681;
 //BA.debugLineNum = 327681;BA.debugLine="CallSub(ImageDownloader, \"ActivityIsPaused\")";
...
RDebugUtils.currentLine=6356992;
 //BA.debugLineNum = 6356992;BA.debugLine="Sub LoginBtn_Click";
RDebugUtils.currentLine=6356993;
 //BA.debugLineNum = 6356993;BA.debugLine="StartActivity(Login)";
...
public static String  _mainbtn_click() throws Exception{
RDebugUtils.currentModule="main";
if (Debug.shouldDelegate(mostCurrent.activityBA, "mainbtn_click", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "mainbtn_click", null));}
RDebugUtils.currentLine=196608;
 //BA.debugLineNum = 196608;BA.debugLine="Sub MainBtn_Click";
RDebugUtils.currentLine=196609;
 //BA.debugLineNum = 196609;BA.debugLine="StartActivity(Layout2)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._layout2.getObject()));
